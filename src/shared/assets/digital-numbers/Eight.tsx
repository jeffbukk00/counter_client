const Eight = ({ classes }: { classes: string }) => {
  return (
    <svg
      version="1.0"
   ...
   -419 -410z"
        />
        <path
          d="M5328 11066 l-408 -412 0 -1485 0 -1484 408 -397 409 -396 411 400
   ...
   -414 414 -1485 0 -1485 0 -393 -406z"
        />
        <path
          d="M413 5490 l-413 -417 0 -1484 0 -1484 401 -389 c220 -214 407 -389
